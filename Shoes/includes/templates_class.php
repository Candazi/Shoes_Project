...
class Template {
  ...
  public function cart_template(){
    ...
    $documents->load('XML/cart.xml');

    $parent_shoes = $documents->getElementsByTagName('shoes');
    $child_shoes  = $documents->getElementsByTagName('shoe');
...
function priceDetails(){
  ...
  $parent_shoes = $documents->getElementsByTagName('shoes')->item(0);
  $child_shoes  = $documents->getElementsByTagName('shoe');
