...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2497477503ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shoes_unlimited_DB&table=users">`shoes_unlimited_DB`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=login_db&table=users">`login_db`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dvwa&table=users">`dvwa`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dvwa&table=guestbook">`dvwa`.`guestbook`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=JWT&table=users">`JWT`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=basics&table=subjects">`basics`.`subjects`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=basics&table=sclasses">`basics`.`sclasses`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=FMS&table=users">`FMS`.`users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2f4a78477b2d3c543b7851297548653b">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="227"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="login_db" targettable="users">
            ...
            Queried time
                            ...
                            <span class="query">use login_db;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="login_db" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">show tables;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="login_db" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="shoes_unlimited_DB" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">create database shoes_unlimited_DB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="shoes_unlimited_DB" targettable="">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">use shoes_unlimited_DB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="shoes_unlimited_DB" targettable="">
                            <div class="action_content">
    ...
    PRIMARY KEY (id)
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="shoes_unlimited_DB" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
